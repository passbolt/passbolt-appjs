...
var CreateForm = Form.extend('passbolt.form.user.Create', /** @static */ {
	...
	afterStart: function () {
		...
		var roleId = getObject(this.options.data, 'User.role_id');
		if (!roleId) {
	 ...
	 * @param val
	 */
	'#js_field_is_admin input change': function(el, ev, val) {
