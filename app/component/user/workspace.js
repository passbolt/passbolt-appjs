...
var UserWorkspaceComponent = Component.extend('passbolt.component.user.Workspace', /** @static */ {
    ...
    _initBreadcrumb: function() {
        var component = new BreadcrumbComponent('#js_wsp_users_breadcrumb', {
    ...
    _initPrimarySidebar: function() {
        var component = new PrimarySidebarComponent('#js_user_workspace_primary_sidebar', {
     ...
     */
    _initGrid: function() {
        var component = new GridComponent('#js_wsp_users_browser', {
            selectedUsers: this.options.selectedUsers,
            silentLoading: false
        });
        component.start();
        ...
        var form = dialog.add(UserCreateForm, {
            ...
            callbacks : {
                submit: function (formData) {
                    var userToCreate = new User(formData['User']);
    ...
    openEditUserDialog: function(user) {
        ...
        var form = dialog.add(UserCreateForm, {
            ...
            callbacks : {
                submit: function (formData) {
                    var userToUpdate = new User(formData['User']);
     ...
     * @param {HTMLEvent} ev The event which occurred
     */
    '{mad.bus.element} request_user_creation': function (el, ev) {
        var user = new User({});
