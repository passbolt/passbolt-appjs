...
var GroupsList = TreeComponent.extend('passbolt.component.group.GroupsList', /** @static */ {
    ...
    _getTreeMap: function() {
        return  new MadMap({
            ...
            canEdit: {
                key: 'id',
                func: (id, map, item) => {
                    var isAdmin = getObject(item, 'my_group_user.is_admin') || User.getCurrent().isAdmin();
                    return isAdmin === true;
                }
            }
        });
